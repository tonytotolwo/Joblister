<?php include 'inc/header.php'; ?>
  ...
  <form method="post" action="edit.php?id=<?php echo $job->id; ?>"> 
    ...
    <input type="text" class="form-control" name="contact_user" value="<?php echo $job->contact_user; ?>"></div>
     
     <div class="form-group">
    <label>Contact_Email</label>
    <input type="text" class="form-control" name="contact_email" value="<?php echo $job->contact_email; ?>"></div>
